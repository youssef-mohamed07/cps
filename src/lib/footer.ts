...
export async function resolveFooter(locale: Locale): Promise<FooterConfig> {
  ...
  return {
    ...
    areasTitle: local.areasTitle,
    areasSupport: local.areasSupport,
    areasAllLabel: local.areasAllLabel,
    areasSearchPlaceholder: local.areasSearchPlaceholder,
    areasEmpty: local.areasEmpty,
    areasServiceLink: local.areasServiceLink,
    showAreas: local.showAreas,
