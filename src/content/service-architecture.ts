...
export const sharedProcess = [
  {
    ...
    description: t(
      ...
      "نراجع موجزك وظروف الموقع والقيود الفنية قبل بدء التصميم",
    ),
  },
  {
  ...
  },
  {
    ...
    description: t(
      ...
      "معاينة نهائية ومعالجة ملاحظات ودعم مستمر إذا احتاج العنصر صيانة أو إعادة نشر",
    ),
  },
];
...
export const serviceArchitecture: ServiceArchitecture[] = [
  {
    ...
    why: {
      ...
      items: [t("In-house wood, metal, acrylic and print production — no subcontracted panels", "إنتاج داخلي للخشب والمعدن والأكريليك والطباعة — بلا ألواح من مقاولين فرعيين"), t("Experience across major KSA exhibition halls", "خبرة في أهم قاعات المعارض بالمملكة"), t("Nationwide installation and dismantling crews", "فرق تركيب وتفكيك على مستوى المملكة"), t("Every layout covered: inline, corner, peninsula, island", "تغطية كل التخطيطات: خطي، زاوية، شبه جزيرة، وجزيرة")],
    },
    benefits: [t("Faster turnaround since design, production and install sit under one roof", "تنفيذ أسرع لأن التصميم والإنتاج والتركيب تحت سقف واحد"), t("Consistent finish quality across every booth type", "جودة تشطيب متسقة عبر كل أنواع الأجنحة"), t("Single point of contact from concept to teardown", "نقطة اتصال واحدة من الفكرة حتى التفكيك"), t("Reusable modular options to cut costs across multiple shows", "خيارات معيارية قابلة لإعادة الاستخدام لخفض التكاليف عبر عدة معارض")],
  ...
  },
  {
    ...
    why: { headline: t("Why brands choose CPS for retail displays", "لماذا تختار العلامات CPS لعروض التجزئة"), support: t("Displays engineered to hold up under daily retail traffic.", "عروض مهندسة لتحمل حركة التجزئة اليومية."), items: [t("Displays engineered for durability under daily foot traffic", "متانة للاستخدام اليومي"), t("In-house acrylic, wood and metal production", "إنتاج داخلي للأكريليك والخشب والمعدن"), t("Multi-location rollout capability", "قدرة على التنفيذ في مواقع متعددة"), t("Fast production for promotional and seasonal campaigns", "إنتاج سريع للحملات الموسمية")] },
    benefits: [t("Consistent quality across multi-store rollouts", "جودة متسقة عبر الفروع"), t("Materials matched to product and brand requirements", "مواد مناسبة لطبيعة المنتج"), t("Scalable from one-off units to national rollouts", "قابلية للتوسع من وحدة واحدة إلى انتشار وطني"), t("Coordinated delivery and installation across locations", "توصيل وتركيب منسقان")],
  ...
  },
  {
    ...
    hero: { headline: t("If it can be engineered, we can build it.", "إذا أمكن هندسته، يمكننا تصنيعه."), support: t("Multi-discipline fabrication under one roof.", "تصنيع متعدد التخصصات تحت سقف واحد."), bullets: [t("Wood & joinery, CNC-cut and finished in-house", "أعمال خشب ونجارة وقطع CNC داخلي"), t("Metal fabrication, framing and powder coating", "تصنيع معدني ودهان بالبودرة"), t("Acrylic fabrication and custom structures", "تصنيع أكريليك وهياكل مخصصة"), t("Mixed-material builds combining several disciplines", "تنفيذات متكاملة بمواد مختلطة")], catalogueCta: t("See All Fabrication Capabilities", "عرض كل قدرات التصنيع") },
    ...
    why: { headline: t("Why brands choose CPS for custom fabrication", "لماذا تختار العلامات CPS للتصنيع المخصص"), support: t("Every major discipline sits under one roof, not spread across subcontractors.", "كل تخصص رئيسي موجود تحت سقف واحد."), items: [t("Multiple disciplines under one roof — no subcontracted trades", "تخصصات متعددة بلا تسليم بين موردين"), t("CNC precision with in-house finishing", "دقة CNC مع تشطيب داخلي"), t("Built to technical drawing, not approximate spec", "تنفيذ وفق الرسومات الفنية"), t("Capacity for both one-off and production-run quantities", "قدرة على القطع الفردية والإنتاج المتكرر")] },
    benefits: [t("Tighter quality control across every material", "رقابة جودة أدق"), t("Faster iteration since fabrication stays in-house", "تعديلات أسرع داخلياً"), t("Mixed-material builds without coordinating separate vendors", "مواد مختلطة بلا موردين منفصلين"), t("Scales from prototypes to full production runs", "من النموذج الأولي إلى الإنتاج الكامل")],
  ...
  },
  {
    ...
    why: { headline: t("Why brands choose CPS for print & signage", "لماذا تختار العلامات CPS للطباعة واللافتات"), support: t("Production and installation come from the same team.", "الإنتاج والتركيب من الفريق نفسه."), items: [t("Production and installation coordinated by one team", "فريق واحد من الإنتاج حتى التركيب"), t("In-house large-format printing, not outsourced", "طباعة كبيرة داخلية"), t("Illuminated and dimensional signage fabricated in-house", "لافتات مضيئة وبارزة تصنع داخلياً"), t("Nationwide installation for indoor and outdoor signage", "تركيب على مستوى المملكة")] },
    benefits: [t("Faster turnaround from print to installed signage", "تنفيذ أسرع من الطباعة للتركيب"), t("Consistent brand colour and finish across formats", "اتساق ألوان العلامة"), t("One quote covers production and installation", "عرض واحد للإنتاج والتركيب"), t("Scales from a single banner to full building signage", "من بانر واحد إلى مبنى كامل")],
  ...
  },
  {
    ...
    why: { headline: t("Why brands choose CPS for rental", "لماذا تختار العلامات CPS للتأجير"), support: t("Owned inventory, not a subcontracted rental house.", "مخزون مملوك لنا وليس مؤجراً من طرف ثالث."), items: [t("Own inventory — not subcontracted through a third-party rental house", "مخزون مملوك ومصان"), t("Delivery, installation and collection handled by one team", "فريق واحد للتوصيل والاستلام"), t("Furniture and displays maintained to a consistent standard", "حالة متسقة للعناصر"), t("Available alongside any other CPS service for the same event", "متاح مع كل خدمات CPS")] },
    benefits: [t("One vendor for rental plus any custom builds needed", "مورد واحد للتأجير والتنفيذ المخصص"), t("Consistent quality and condition across items", "جودة متسقة"), t("Flexible short-term terms for single events", "مدد تأجير قصيرة ومرنة"), t("Coordinated delivery and collection around your schedule", "توصيل واستلام منسقان")],
  ...
  },
  {
    ...
    catalogue: { title: t("All Delivery Services", "كل خدمات التسليم"), support: t("Every service that gets a finished build from the production floor to a working site.", "كل خدمة تنقل التنفيذ المكتمل من أرض الإنتاج إلى موقع يعمل بكفاءة."), categories: [
    ...
    why: { headline: t("Why brands choose CPS for delivery", "لماذا تختار العلامات CPS للتسليم"), support: t("Nationwide crews, not subcontracted labour.", "فرق وطنية وليست عمالة من الباطن."), items: [t("Nationwide crews, not subcontracted labour", "فرق داخلية على مستوى المملكة"), t("Site surveys and technical prep reduce on-site surprises", "المعاينات تقلل مفاجآت الموقع"), t("Storage and redeployment options for reusable assets", "خيارات تخزين وإعادة استخدام"), t("Quality control and snagging built into every handover", "ضبط جودة حتى التسليم")] },
    benefits: [t("One team from planning through final handover", "فريق واحد حتى التسليم"), t("Reduced risk from miscommunication between vendors", "أخطاء تنسيق أقل بين الموردين"), t("Storage options between exhibitions or events", "تخزين بين مرات الاستخدام"), t("Maintenance and refurbishment extend asset life", "الصيانة تطيل عمر الأصول")],
