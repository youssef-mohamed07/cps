  ...
  ar: {
    ...
    services: {
      ...
      items: [
        ...
        { title: "الطباعة واللافتات", description: "رسومات كبيرة وهوية بيئية وأنظمة لافتات.", image: media.services.printing, imageAlt: "الطباعة واللافتات", slug: "printing-signage" },
        { title: "حلول التأجير", description: "أصول قابلة لإعادة الاستخدام للفعاليات والمعارض والعرض.", image: media.services.rental, imageAlt: "مخزون التأجير", slug: "rental-solutions" },
