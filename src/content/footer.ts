...
function footerEn(): FooterConfig {
  return {
    ...
    description:
      "CPS designs, fabricates, and installs exhibition booths end-to-end — from concept to teardown across Saudi Arabia and the region.",
    certifications: [],
    qualityBadges: [],
...
function footerAr(): FooterConfig {
  return {
    ...
    description:
      "CPS تصمم وتصنع وتركّب أجنحة المعارض من البداية للنهاية — من المفهوم إلى التفكيك في السعودية والمنطقة.",
    certifications: [],
    qualityBadges: [],
    ...
    businessHours: "الأحد – الخميس\n9:00 ص – 6:00 م (توقيت السعودية)",
