...
export const siteSettings = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: "image",
      title: "Brand icon",
      description: "Compact brand mark used in the header and interface details.",
      options: { hotspot: true },
      fields: [defineField({ name: "alt", type: "string", title: "Alt text" })],
    }),
    defineField({
    ...
    defineField({
      ...
      fields: [
        defineField({ name: "enabled", type: "boolean", title: "Show in header", initialValue: true }),
        defineField({ name: "labelEn", type: "string", title: "English label" }),
        defineField({ name: "labelAr", type: "string", title: "Arabic label" }),
        defineField({
          name: "file",
          type: "file",
          title: "Portfolio PDF",
          description: "Uploaded file takes priority over the external URL.",
          options: { accept: "application/pdf,.pdf" },
        }),
        defineField({ name: "externalUrl", type: "url", title: "External fallback URL" }),
      ],
    }),
