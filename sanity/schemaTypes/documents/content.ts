...
export const project = defineType({
  ...
  fields: [
    ...
    defineField({ name: "scopeOfWork", type: "text", rows: 3, title: "Scope of Work" }),
    defineField({
      name: "hero",
      type: "image",
      title: "Hero image",
    ...
    defineField({
      ...
      options: {
        list: [
          { title: "Exhibitions & Booths", value: "exhibitions-booths" },
          { title: "Event Fabrication", value: "event-fabrication" },
          { title: "Fit-Out & Interiors", value: "fit-out-interiors" },
          { title: "Retail Displays", value: "retail-displays" },
          { title: "Custom Fabrication", value: "custom-fabrication" },
          { title: "Printing & Signage", value: "printing-signage" },
          { title: "Rental Solutions", value: "rental-solutions" },
          { title: "Installation & Project Delivery", value: "installation-project-delivery" },
        ],
      },
    }),
    defineField({
      ...
      description: "Structured project metadata used by the public Work filters.",
      options: {
        list: [
          ...
          { title: "Healthcare & Pharmaceutical", value: "healthcare-pharmaceutical" },
          { title: "FMCG", value: "fmcg" },
          { title: "Beauty & Cosmetics", value: "beauty-cosmetics" },
          { title: "Technology & Electronics", value: "technology-electronics" },
          { title: "Automotive", value: "automotive" },
          { title: "Retail & Shopping Malls", value: "retail-shopping-malls" },
